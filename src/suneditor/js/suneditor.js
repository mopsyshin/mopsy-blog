    ...
    var createEditor = function (options){
        ...
        var toolBar = function() {
            ...
            if(options.showLine) {
                html += ''+
                    ...
                    '                <hr style="border-width: 1px 0 0; border-style: solid none none; border-color: #bbb; border-image: initial; height: 1px;" />'+
                    '                <hr style="border-width: 1px 0 0; border-style: dotted none none; border-color: #bbb; border-image: initial; height: 1px;" />'+
                    '                <hr style="border-width: 1px 0 0; border-style: dashed none none; border-color: #bbb; border-image: initial; height: 1px;" />'+
                    '            </button>'+
        ...
        var dialogBox = function() {
            ...
            html += ''+
                ...
                '            </div>'+
                '            <div class="modal-body">'+
                '                 <div class="form-group imgbox-file">'+
